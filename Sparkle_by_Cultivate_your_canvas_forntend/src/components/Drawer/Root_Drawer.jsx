...
import logo from '../../assets/logo/Sparkle_By_CYC.svg';
...
const navLinks = [
  ...
  { path: "/admissionform", name: "Admission form" },
...
const Root_Drawer = () => {
  ...
  return (
    <div className="relative">
      ...
      {/* Overlay */}
      {isOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-70 backdrop-blur-md filter blur-md z-40 h-[100vh] overflow-x-hidden"></div>
      )}

      {/* Drawer */}
      <div
        ref={drawerRef}
        className={`bg-white text-black fixed top-0 right-0 h-[100vh] w-[80vw] sm:w-[300px] transform transition-transform duration-300 z-40  ${isOpen ? "translate-x-0" : "translate-x-full"
          }`}
