...
const Booking = () => {
  return (
    <div className='flex flex-wrap items-center justify-between md:gap-5 p-10 md:p-20 gap-5 bg-gradient-to-tr from-yellow-500 to bg-orange-500 text-start text-white'>
