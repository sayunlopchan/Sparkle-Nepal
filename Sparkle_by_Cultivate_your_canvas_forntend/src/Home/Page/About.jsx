        ...
        <div className="pb-10 w-[90%] m-auto space-y-20">
            ...
            <div className="bg-white lg:col-span-5 lg:row-span-12 p-10 space-y-5 lg:space-y-10 rounded-3xl max-lg:order-2">
              ...
              <div>
                <p className="text-sm text-gray-700">
                  ...
                  , founded by <strong>Sneha Raut Thapa</strong>, is dedicated
                  to grooming children for the future by offering a wide range
                  of training programs. Inspired by her love for children and
                  the desire to provide what her generation missed, Sneha
                  created Sparkle to help kids develop essential life skills and
                  confidence. Through courses in public speaking, dance, art,
                  and personal grooming, Sparkle Kids Academy is committed to
                  empowering the next generation with the resources they need to
                  succeed.
                </p>
              </div>
            </div>
          ...
          <div className="flex max-lg:flex-wrap justify-between rounded-lg overflow-hidden gap-5 p-10 bg-white">
            ...
            <div className="bg-gray-50 w-full rounded-3xl p-5 space-y-5">
              ...
              <p className="text-sm text-gray-700">
                Our vision is to become a leading educational and training
                academy for children, redefining childhood education through
            ...
            <div className="bg-gray-50 w-full rounded-3xl p-5 space-y-5">
              ...
              <p className="text-sm text-gray-700">
                Our mission is to revolutionize early childhood education in
                Nepal by offering high-quality, hands-on learning experiences
                tailored to the unique needs and interests of young learners.
                Through our training and workshops, we aim to enhance cognitive
                development, foster problem-solving skills, and inspire a
